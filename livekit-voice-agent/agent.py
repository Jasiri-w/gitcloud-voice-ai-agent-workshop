...
async def my_agent(ctx: agents.JobContext):
    ...
    base_instructions = "You are a helpful voice AI assistant. You can use the tools provided to you to help the user (Zapier MCP Server). Be concise in voice responses."
